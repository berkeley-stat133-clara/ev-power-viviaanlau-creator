...
library(tigris)
library(viridis)
renew_2021 <- read_csv("ev-power-viviaanlau-creator/data/renew-use-2021.csv")
renew_2022 <- read_csv("ev-power-viviaanlau-creator/data/renew-use-2022.csv")
renew_2023 <- read_csv("ev-power-viviaanlau-creator/data/renew-use-2023.csv")
avg_price <- read_csv("ev-power-viviaanlau-creator/data/av-energy-price-2021-2023.csv")
total_2021 <- read_csv("ev-power-viviaanlau-creator/data/total-use-2021.csv")
total_2022 <- read_csv("ev-power-viviaanlau-creator/data/total-use-2022.csv")
total_2023 <- read_csv("ev-power-viviaanlau-creator/data/total-use-2023.csv")
registration <- read_csv("ev-power-viviaanlau-creator/data/ev-registrations-by-state-2023.csv")
```
...
ggsave("map_plot.png", width = 100, height = 60)
```
